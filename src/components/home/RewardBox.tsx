...
export const RewardBox = forwardRef<RewardBoxHandle, RewardBoxProps>(function RewardBox(
  { disabled = false, showPing, accessibilityLabel = '기부 상자 열기', onPress },
  ref,
) {
    ...
    >
      <Animated.View
        style={[
          ...
          disabled ? styles.rewardBoxIconDisabled : null,
          {
            transform: [
      ...
      >
        <View style={styles.rewardBoxGraphic}>
          <View style={styles.rewardBoxBowRow}>
            <View style={[styles.rewardBoxBowLeft, disabled ? styles.strokeDisabled : null]} />
            <View style={[styles.rewardBoxBowRight, disabled ? styles.strokeDisabled : null]} />
          </View>
          <View style={[styles.rewardBoxLid, disabled ? styles.strokeDisabled : null]} />
          <View style={[styles.rewardBoxBody, disabled ? styles.strokeDisabled : null]} />
          <View style={[styles.rewardBoxRibbonVertical, disabled ? styles.fillDisabled : null]} />
        </View>
        {isPingVisible ? (
