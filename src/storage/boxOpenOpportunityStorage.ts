...
export const BOX_OPEN_OPPORTUNITY_STORAGE_KEY = 'gibukim:v1:box-open-opportunity';
...
const boxOpenOpportunityStorageGateway = createBoxOpenOpportunityStorageGateway(Storage);

export async function readBoxOpenOpportunity(): Promise<unknown | null> {
  return boxOpenOpportunityStorageGateway.read();
}

export async function writeBoxOpenOpportunity(opportunity: BoxOpenOpportunity): Promise<void> {
